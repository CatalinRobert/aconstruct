...
return [
    ...
    'products' => [
        ...
        'view' => [
            'type' => [
                'configurable' => [
                    'select-options'       => 'Selecteaza o optiune',
            ...
            'already-in-compare'     => 'Produs deja adaugat in lista de comparare',
            'additional-information' => 'Informatii Aditionale',
            'buy-now'                => 'Cumpara Acum',
            'compare'                => 'Compara',
            'description'            => 'Descriere',
            'related-product-title'  => 'Produse din aceeasi gama',
            'review'                 => 'Reviews',
            'tax-inclusive'          => 'Inclusive of all taxes',
            'up-sell-title'          => 'S-ar putea sa iti placa',
        ],
    ...
    'search' => [
        'title'   => 'Rezultate afisate pentru : :query',
        'results' => 'Cauta rezultate',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'index' => [
                ...
                'empty-product'            => 'Nu ai produse in cos',
                'home'                     => 'Acasa',
                'excl-tax'                 => 'Excl. Tax:',
